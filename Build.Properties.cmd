...
SET BUILD_PARAMETER___VERSION_DEFAULT=8.0.0
SET BUILD_PARAMETER___CONFIGURATION_DEFAULT=Release

SET BUILD_PARAMETERS=^
    "Wpf.Effects.sln|%BUILD_PARAMETER___VERSION_DEFAULT%|%BUILD_PARAMETER___CONFIGURATION_DEFAULT%"
...
SET TEST_PARAMETER___TARGET_FRAMEWORKS_DEFAULT=net8.0-windows;net7.0-windows;net6.0-windows;net48
