...
SET "PARAMETER___VERSION___DEFAULT=10.0.0"
SET "PARAMETER___CONFIGURATION___DEFAULT=Release"
SET "PARAMETER___FRAMEWORKS___DEFAULT=net10.0-windows;net9.0-windows;net8.0-windows;net48"
...
REM ================================================================================
REM BUILD UNIT: Wpf.Effects
REM ================================================================================

SET BUILD_UNIT___Wpf.Effects___BUILD_PARAMETERS=^
    "Wpf.Effects.slnx|%PARAMETER___FRAMEWORKS___DEFAULT%"

REM SET BUILD_UNIT___Wpf.Effects___TEST_PARAMETERS=^
REM     "Wpf.Effects.Tests.dll|%PARAMETER___FRAMEWORKS___DEFAULT%"

SET BUILD_UNIT___Wpf.Effects___PACKAGE_PARAMETERS=^
    "Wpf.Effects.csproj|%PARAMETER___FRAMEWORKS___DEFAULT%"

SET BUILD_UNIT___Wpf.Effects___PACKAGE_NEV_PARAMETERS=^
    "Wpf.Effects."
