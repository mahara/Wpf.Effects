...
REM ECHO ------------------------------------
REM ECHO Running .NET (net9.0) Unit Tests
REM ECHO ------------------------------------

REM dotnet test "%ARTIFACTS_OUTPUT_BUILD_CONFIGURATION_FOLDER_PATH%\net9.0\Wpf.Effects.Tests\Wpf.Effects.Tests.dll" --results-directory "%ARTIFACTS_TEST_RESULTS_FOLDER_PATH%" --logger "nunit;LogFileName=Wpf.Effects.Tests_net9.0_TestResults.xml;format=nunit3"

REM ECHO ------------------------------------
REM ECHO Running .NET (net8.0) Unit Tests
REM ECHO ------------------------------------

REM dotnet test "%ARTIFACTS_OUTPUT_BUILD_CONFIGURATION_FOLDER_PATH%\net8.0\Wpf.Effects.Tests\Wpf.Effects.Tests.dll" --results-directory "%ARTIFACTS_TEST_RESULTS_FOLDER_PATH%" --logger "nunit;LogFileName=Wpf.Effects.Tests_net8.0_TestResults.xml;format=nunit3"

REM ECHO --------------------------------------------
REM ECHO Running .NET Framework (net48) Unit Tests
REM ECHO --------------------------------------------

REM dotnet test "%ARTIFACTS_OUTPUT_BUILD_CONFIGURATION_FOLDER_PATH%\net48\Wpf.Effects.Tests\Wpf.Effects.Tests.exe" --results-directory "%ARTIFACTS_TEST_RESULTS_FOLDER_PATH%" --logger "nunit;LogFileName=Wpf.Effects.Tests_net48_TestResults.xml;format=nunit3"
